-- =====================================================================
-- Add Geo-IP anomaly tracking columns to session_logs and update RPC
-- =====================================================================

-- 1. Add columns for tracking resolved location and anomaly status
ALTER TABLE public.session_logs 
  ADD COLUMN IF NOT EXISTS location TEXT,
  ADD COLUMN IF NOT EXISTS is_suspicious BOOLEAN DEFAULT false;

-- 2. Update the get_login_history RPC to return the new columns
DROP FUNCTION IF EXISTS public.get_login_history(TEXT, TEXT, INTEGER);
